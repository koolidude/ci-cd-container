...
resource "aws_ecs_task_definition" "own_task_definition" {
  ...
  #   image_url        = "255945442255.dkr.ecr.us-east-1.amazonaws.com/norshukri-test-ecr-repo:latest"
  #   container_name   = "norshukri-test-ecs"
  #   port_name        = "norshukri-test-ecs-8080-tcp"
  #   log_group_region = "us-east-1"
  #   log_group_name   = "/ecs/norshukritesttaskdef"
